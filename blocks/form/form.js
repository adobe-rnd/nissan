import {
  createButton, createFieldWrapper, getHTMLRenderType,
  createHelpText,
  stripTags,
  checkValidation,
  addOptions,
...
const createSelect = withFieldWrapper((fd) => {
  ...
  addOptions(fd, select, fd.enum, fd.enumNames);

  if (ph && !select.selectedIndex) { // TODO: verify for dropdowns without default value
